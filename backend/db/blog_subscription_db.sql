...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2025 at 10:56 AM
...
ALTER TABLE `saved_posts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_save` (`blog_id`,`user_id`),
  ADD KEY `user_id` (`user_id`);
...
--
ALTER TABLE `saved_posts`
  ADD CONSTRAINT `saved_posts_ibfk_1` FOREIGN KEY (`blog_id`) REFERENCES `blogs` (`id`) ON DELETE CASCADE,
