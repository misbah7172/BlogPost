...
const CreateBlog = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const blogDataWithMindmap = {
        ...formData,
        mindmapData: mindmapData
      };
      
      const response = await blogService.createBlog(blogDataWithMindmap);
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-2 border-purple-300 dark:border-purple-600 p-4 rounded">
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  {showMindmapEditor ? 'Hide Mindmap Editor' : 'Create Mindmap'}
                </button>
              </div>
              ...
              <p className="text-sm text-purple-600 dark:text-purple-400 mt-2">
                Create an interactive mindmap to help readers visualize and understand your blog content better.
              </p>
            </div>
